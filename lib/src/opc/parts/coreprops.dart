...
class CorePropertiesPart extends XmlPart {
  CorePropertiesPart(PackUri partname, String contentType,
      CT_CoreProperties element, OpcPackage package)
  ...
  static CorePropertiesPart defaultPart(OpcPackage package) {
    ...
    final part = CorePropertiesPart(
        partname, contentType, corePropertiesElement, package);
  ...
  CoreProperties get coreProperties =>
      CoreProperties(element as CT_CoreProperties);
