...
class CT_Color extends BaseOxmlElement {
  ...
  static XmlElement create(String nsptagname, Object val) {
    ...
    if (xmlVal == null) {
      ...
      throw ArgumentError(
          "Cannot create CT_Color with null xml value from $val");
    }
...
class CT_RPr extends BaseOxmlElement {
  ...
  /// Qualified name for the <w:rPr> element.
  static final qnTagName = qn('w:rPr');
  ...
  static final List<String> _snapToGridSuccessors =
      _noProofSuccessors.sublist(1);
  static final List<String> _vanishSuccessors =
      _snapToGridSuccessors.sublist(1);
  ...
  CT_VerticalAlignRun? _getCTVerticalAlignRun(String tag) =>
      childOrNull(tag) == null ? null : CT_VerticalAlignRun(childOrNull(tag)!);
  ...
  CT_Underline getOrAddU() => CT_Underline(getOrAddChild(
      _wU, _uSuccessors, _factoryU)); // Renamed from addU for consistency
  ...
  static XmlElement _factoryRStyle() =>
      CT_String.create(_wRStyle, ''); // Needs initial val
  static XmlElement _factoryRFonts() => OxmlElement(_wRFonts);
  static XmlElement _factorySz() =>
      CT_HpsMeasure.create(_wSz, Length(0)); // Now calls class method
  static XmlElement _factoryHighlight() => CT_Highlight.create(
      _wHighlight, WD_COLOR_INDEX.AUTO); // Now calls class method
  static XmlElement _factoryU() => CT_Underline.create(
      _wU, WD_UNDERLINE.INHERITED); // Now calls class method
  static XmlElement _factoryVertAlign() => CT_VerticalAlignRun.create(
      _wVertAlign,
  ...
  static XmlElement _factoryOnOff(String tag) =>
      OxmlElement(tag); // General factory
  ...
  set style(String? value) {
    if (value == null) {
      ...
      final rStyleElement =
          getOrAddChild(_wRStyle, _rStyleSuccessors, _factoryRStyle);
  ...
  void _setBoolProp(String tagName, bool? value, List<String> successors) {
    if (value == null) {
      ...
      final onOffElement =
          getOrAddChild(tagName, successors, () => _factoryOnOff(tagName));
  ...
  set smallCaps(bool? value) =>
      _setBoolProp(_wSmallCaps, value, _smallCapsSuccessors);
  ...
  set doubleStrike(bool? value) =>
      _setBoolProp(_wDstrike, value, _dstrikeSuccessors);

  bool? get outline => _getBoolProp(_wOutline);
  set outline(bool? value) =>
      _setBoolProp(_wOutline, value, _outlineSuccessors);
  ...
  set imprint(bool? value) =>
      _setBoolProp(_wImprint, value, _imprintSuccessors);

  bool? get noProof => _getBoolProp(_wNoProof);
  set noProof(bool? value) =>
      _setBoolProp(_wNoProof, value, _noProofSuccessors);

  bool? get snapToGrid => _getBoolProp(_wSnapToGrid);
  set snapToGrid(bool? value) =>
      _setBoolProp(_wSnapToGrid, value, _snapToGridSuccessors);
  ...
  set webHidden(bool? value) =>
      _setBoolProp(_wWebHidden, value, _webHiddenSuccessors);
  ...
  set specVanish(bool? value) =>
      _setBoolProp(_wSpecVanish, value, _specVanishSuccessors);
...
class CT_Underline extends BaseOxmlElement {
  ...
  WD_UNDERLINE? get val => getAttrVal('w:val', wdUnderlineConverter,
      defaultValue: WD_UNDERLINE.INHERITED);
  // Use INHERITED as default, setting null removes attribute
  set val(WD_UNDERLINE? value) =>
      setAttrVal('w:val', value, wdUnderlineConverter,
          defaultValue: WD_UNDERLINE.INHERITED);

  /// Creates a new `XmlElement` suitable for a CT_Underline.
  static XmlElement create(String nsptagname, WD_UNDERLINE? val) {
    // Accept null
...
class CT_VerticalAlignRun extends BaseOxmlElement {
  ...
  set val(String value) =>
      setReqAttrVal('w:val', value, stVerticalAlignRunConverter);
