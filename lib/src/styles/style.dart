...
class BaseStyle extends ElementProxy {
  ...
  String? get name {
    final nameEl = _xml.findElements('name', namespace: nsmap['w']).firstOrNull;
  ...
  String? get styleId => _xml.getAttribute('styleId', namespace: nsmap['w']);
  ...
  void _removeChild(String localName) {
    final child =
        _xml.findElements(localName, namespace: nsmap['w']).firstOrNull;
    if (child != null) {
